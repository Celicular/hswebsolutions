...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    const isLight =
      savedTheme === "true" || (savedTheme === null && prefersLight);
  ...
  const toggleTheme = () => {
    ...
    document.dispatchEvent(
      new CustomEvent("themeChanged", { detail: { lightMode: newMode } })
    );
  };
    ...
    <>
      ...
      <nav className={styles.navbar}>
        ...
        <div className={styles.navCenter}>
          ...
          <Link href="/billings" className={styles.navLink}>
            Billings
          </Link>
        ...
        <div className={styles.sidebarContent}>
          ...
          <form className={styles.contactForm} onSubmit={handleSubmit}>
            ...
            <div className={styles.formGroup}>
              ...
              />
              {formErrors.mobile && (
                <p className={styles.formError}>{formErrors.mobile}</p>
              )}
            </div>
          ...
          <div className={styles.mapContainer}>
            <iframe
              src={`https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3678.615154595861!2d86.16426066270446!3d22.77965911349691!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f5e4ba54d9a46d%3A0x943c1e78c8462838!2sAdharshila%20Tower!5e0!3m2!1sen!2sin!4v1746120762203!5m2!1sen!2sin${
                lightMode ? "" : "&style=dark"
              }`}
              width="100%"
              height="200"
              style={{ border: 0 }}
